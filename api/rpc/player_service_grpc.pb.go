...
func (c *playerServiceClient) MovePlayer(ctx context.Context, in *MovePlayerRequest, opts ...grpc.CallOption) (*MovePlayerResponse, error) {
	out := new(MovePlayerResponse)
	err := c.cc.Invoke(ctx, "/PlayerService/MovePlayer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPlayerServiceServer) MovePlayer(context.Context, *MovePlayerRequest) (*MovePlayerResponse, error) {
...
func _PlayerService_MovePlayer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MovePlayerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PlayerServiceServer).MovePlayer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/PlayerService/MovePlayer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlayerServiceServer).MovePlayer(ctx, req.(*MovePlayerRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _PlayerService_MovePlayer_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "player_service.proto",
}
